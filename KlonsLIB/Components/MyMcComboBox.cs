    ...
    public class MyMcComboBox : ComboBox
    {
        ...
        */
        ...
        private string ItemString2(int row)
        {
            ...
            var itemtext = GetItemText(Items[row]);
            return itemtext;
        }
        ...
        private string ItemString(int row, int col)
        {
            ...
            if (FormattingEnabled && m_ColumnNames != null && m_ColumnNames.Length == 1)
            {
                return GetItemText(Items[row]);
            }
        ...
        protected override void OnDrawItem(DrawItemEventArgs e)
        {
            ...
            if (!DroppedDown && DropDownStyle == CustomDropDownStyle.DropDownListSimple)
            {
                ...
                r1.Width = r.Width;
                e.Graphics.DrawString(celltext, Font, textbrush, r1, sf);
            ...
            if (ColumnCount == 0)
            {
                celltext = GetItemText(Items[e.Index]);
            ...
            else
            {
                for (i = 0; i < ColumnCount; i++)
                {
                    ...
                    if (r1.Width > 0)
                    {
                        ...
                        {
                            e.Graphics.DrawLine(gridpen, r1.X, r1.Y, r1.X, r1.Bottom);
                        }
                    }
                    r1.X += wcols2[i];
                }
