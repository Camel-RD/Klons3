    ...
    public class MyDgvMcComboBox : DataGridViewComboBoxEditingControl
    {
        ...
        public string ColumnWidths
        {
            ...
            set
            {
                ...
                if (ws.Length == 0) m_ColumnWidth = "100";
        ...
        */
        ...
        public void ScaleControlA(SizeF factor)
        {
            ...
            DropDownWidth = (int)((float)DropDownWidth * width);
        ...
        private void CheckColumns()
        {
            ...
            if (w1 != DropDownWidth) DropDownWidth = w1;
        ...
        public new object SelectedValue
        {
            ...
            set
            {
                ...
                /*
                string sv = SelectedValue as string;
                if (sv != null && sv != Text)
                {
                    Text = sv;
                }
