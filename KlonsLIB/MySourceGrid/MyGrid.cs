...
namespace KlonsLIB.MySourceGrid
{
    ...
    public class MyGrid : Grid, IGenericCollectionEditorTarget, IApplyColorTheme
    {
        ...
        public MyGrid()
        {
            ...
            var mouseselectioncontroller = new SourceGrid.Cells.Controllers.MouseSelection();

            Controller.RemoveController(SourceGrid.Cells.Controllers.StandardBehavior.Default);
            Controller.RemoveController(mouseselectioncontroller);
            ...
            Controller.AddController(mouseselectioncontroller);
        ...
        public void OnCreatedNew(object item)
        {
            if (item is MyGridRowBase gr)
            {
                gridRowList.OnNewItem(item);
            }
        }

        public Type[] GetGenericCollectionTypes(string propname)
        {
            if (propname == "RowList")
            {
                return new Type[]
