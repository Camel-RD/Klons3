...
namespace KlonsP.Classes
{
    public class EventRepInfo : EventInfo, IComparable<EventRepInfo>, IComparable
    {
        ...
        {
            SCat1 = MyData.DbContextP.P_CAT1.Find(Cat1).CODE;
            SCatD = MyData.DbContextP.P_CATD.Find(CatD).CODE;
            SCatT = MyData.DbContextP.P_CATT.Find(CatT).CODE;
            SDepartment = MyData.DbContextP.P_DEPARTMENTS.Find(Department).CODE;
            SPlace = MyData.DbContextP.P_PLACES.Find(Place).CODE;
        }
        ...
        public string GetDescr(int k)
        {
            switch (k)
            {
                case 0: return MyData.DbContextP.P_CAT1.Find(Cat1).DESCR;
                case 1: return MyData.DbContextP.P_CATD.Find(CatD).DESCR;
                case 2: return MyData.DbContextP.P_CATT.Find(CatT).DESCR;
                case 3: return MyData.DbContextP.P_DEPARTMENTS.Find(Department).DESCR;
                case 4: return MyData.DbContextP.P_PLACES.Find(Place).DESCR;
            }
            return null;
        }
