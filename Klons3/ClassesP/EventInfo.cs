...
namespace KlonsP.Classes
{
    ...
    public class EventInfo : EventInfo0
    {
        ...
        public void RecalcA()
        {
            RateD = MyData.DbContextP.P_CATD.Find(CatD).RATE / 100.0f;
            TaxRate = MyData.DbContextP.P_CATT.Find(CatT).RATE / 100.0f;
