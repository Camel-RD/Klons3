...
namespace KlonsF.FormsReportParams
{
    public partial class FormRep_ApgrMT : MyFormBaseF
    {
        ...
        private void DoIt()
        {
            ...
            List<F_TREPMT> rows_trepmt = null;

            switch (cmid)
            {
                case 0:
                    rows_trepmt = DataLoaderF.TREPMT_GetBy_apgr_mt_11(startDate, endDate, ac);
                    break;
                case 1:
                case 2:
                    rows_trepmt = DataLoaderF.TREPMT_GetBy_apgr_mt_12(startDate, endDate, ac);
                    break;
                case 3:
                    rows_trepmt = DataLoaderF.TREPMT_GetBy_apgr_mt_21(startDate, endDate, ac);
                    break;
                case 4:
                    rows_trepmt = DataLoaderF.TREPMT_GetBy_apgr_mt_22(startDate, endDate, ac);
                    break;
            }

            MyData.ReportHelperF.PrepareTRepMT(rows_trepmt);
            ...
            rd.Sources["DataSet1"] = rows_trepmt;
