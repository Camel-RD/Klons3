...
namespace KlonsF.FormsReportParams
{
    public partial class FormRep_SkaidraNauda : MyFormBaseF
    {
        ...
        private void DoIt(int k)
        {
            ...
            if(k == 1)
                rows_rops1a = DataLoaderF.ROPS1A_GetBy_skaidra_01(startDate, endDate, limit1, "JP");
            else
                rows_rops1a = DataLoaderF.ROPS1A_GetBy_skaidra_02(startDate, endDate, limit1, "FP");
