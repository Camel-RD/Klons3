...
{
    public partial class FormA_SalarySheetTempl : MyFormBaseF
    {
        public FormA_SalarySheetTempl()
        {
            InitializeComponent();
        ...
        private void BsShR_ListItemPropertyChanged(object sender, KlonsLIB.Data.MyItemPropertyChangedEventArgs e)
        {
            if (e.PropertyName == nameof(A_SALARY_SHEET_TEMPL_R.Person))
            {
                var dr = e.Item as A_SALARY_SHEET_TEMPL_R;
        ...
        private void SelectCurrent()
        {
            ...
            var dr = bsShL.GetCurrentItem<A_SALARY_SHEET_TEMPL>();
        ...
        public void GetIDPFromDialog()
        {
            ...
            var dr = dgvShR.GetCurrentObjectViewItem<A_SALARY_SHEET_TEMPL_R>();
        ...
        public void GetIDDepFromDialog()
        {
            ...
            var ret = fm.ShowMyDialogModal();
            if (ret != DialogResult.OK) return;
            var dr = dgvShL.GetCurrentObjectViewItem<A_SALARY_SHEET_TEMPL>();
        ...
        {
            var enabled = bsShL.Count > 0 && dgvShL.CurrentRow != null && 
        ...
        {
            e.Row.Cells[dgcShLSnr.Index].Value = (short)dgvShL.Rows.Count;
        }
        ...
        private void RenumRows()
        {
            ...
            {
                var dr = bsShR.GetItem<A_SALARY_SHEET_TEMPL_R>(i);
