...
{
    public partial class FormA_Stats : MyFormBaseF
    {
        public FormA_Stats()
        {
            InitializeComponent();
        ...
        public List<A_SP_STATS_02> Stats2Table = null;
        ...
        public void DoGetStats()
        {
            ...
            var table = DataLoaderA.GetBy_A_SP_STATS_01(dt1, dt2);
            Stats2Table = DataLoaderA.GetBy_A_SP_STATS_02(dt1, dt2);
