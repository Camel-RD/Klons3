...
namespace KlonsA.Classes
{
    public class Report_SalaryCalc1
    {
        ...
        public static void MakeReport1(A_SALARY_SHEETS_R dr_lapas_r)
        {
        ...
        public static bool SaveReportToPdf(A_SALARY_SHEETS_R dr_lapas_r, string filename)
        {
            var rd = MakeReportData(dr_lapas_r);
        ...
        public static ReportViewerData MakeReportData(A_SALARY_SHEETS_R dr_lapas_r)
        {
