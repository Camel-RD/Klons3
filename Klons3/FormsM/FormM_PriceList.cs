...
namespace KlonsM.FormsM
{
    public partial class FormM_PriceList : MyFormBaseF, IMyDgvTextboxEditingControlEvents2
    {
        ...
        public M_PRICE_LISTS GetDiscountList()
        {
            return FormM_PriceLists.GetList();
        }
        ...
        private void SetCurrentCellValue(DataGridView dgv, object value)
        {
            ...
            {
                dgv.BeginEdit(false);
                if (dgv.EditingControl is MyMcComboBox c1)
            ...
            int startindex = 0, bool forward = true)
        {
            ...
            var dr0 = bsRowsR.GetItem<M_PRICE_LISTS_R>(startindex);
            ...
            {
                var dr = bsRowsR.GetItem<M_PRICE_LISTS_R>(i);
                if (dr == null) continue;
                val = null;
            ...
            int startindex = 0, bool forward = true)
        {
            ...
            var dr0 = bsRowsP.GetItem<M_PRICE_LISTS_P>(startindex);
            if (dr0 == null) return -1;
            var propdef = TypeDescriptor.GetProperties(dr0)[propname];
            if (propdef == null) return -1;
            int di = forward ? 1 : -1;
            ...
            {
                var dr = bsRowsP.GetItem<M_PRICE_LISTS_P>(i);
                if (dr == null) continue;
                val = null;
        ...
        public void DoImportData()
        {
            ...
            var dr_list = bsLists.GetCurrentItem<M_PRICE_LISTS>();
            ...
            var table_pricelist_r = MyData.DbContextM.BL_M_PRICE_LISTS_R;
            var drs_rows = dr_list.ForItems;
            ...
            foreach(var row_price in fm.Result)
            {
                ...
                {
                    var dr_new = table_pricelist_r.NewItem();
                    dr_new.PriceList = dr_list;
                    dr_new.IDITEM = iditem;
                    dr_new.PRICE = row_price.Price;
                    table_pricelist_r.Add(dr_new);
                }
            }
            CheckSave();
