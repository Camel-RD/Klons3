...
namespace KlonsM.FormsM
{
    public partial class FormM_RepMovementPerSupplier : MyFormBaseF
    {
        ...
        public void MakeReport()
        {
            ...
            var table = DataLoaderM.GetBy_SP_M_REP_ITEMSAMOUNTS_4(Date1, Date2, IdCat);
            if (table.Count == 0)
            {
            ...
            foreach (var dr_rep in table)
            {
                if (reprow is null || dr_rep.IDSTORE != reprow.Id)
                {
                    ...
                    var dr_store = MyData.DbContextM.M_STORES.Find(reprow.Id);
        ...
        {
            var dr_selected = (M_ITEMS_CAT)tbCode.SelectedValue;
