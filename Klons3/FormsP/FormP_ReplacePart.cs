...
{
    public partial class FormP_ReplacePart : MyFormBaseF
    {
        public FormP_ReplacePart()
        {
            InitializeComponent();
        ...
        public string DoCalc()
        {
            ...
            if (IdIt == int.MinValue || 
                (dr = MyData.DbContextP.P_ITEMS.Find(IdIt)) == null)
            ...
            replacePartData1.fDeprec = DataTasksP.Round(replacePartData1.fValue *
