...
{
    public partial class FormP_Search : MyFormBaseF
    {
        public FormP_Search()
        {
            InitializeComponent();
        ...
        private static FormP_Search Instance = null;

        private Form _onForm = null;

        public Action<string, ESerchDirection> OnSearch = null;

        public static FormP_Search Show(Action<string, ESerchDirection> onsearch , Form onform)
        {
