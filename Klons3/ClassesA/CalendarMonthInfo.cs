...
namespace KlonsA.Classes
{
    ...
    public class CalendarMonthInfo
    {
        ...
        public void GetHDays()
        {
            ...
            //var ad = KlonsData.St.KlonsATableAdapterManager.HOLIDAYSTableAdapter as HOLIDAYSTableAdapter;
            //var table_hloidays = ad.GetDataBy_SP_HOLIDAYS_01(dt1, dt2);

            var table_holidays = KlonsData.St.DbContextA.GetBindingListByType<A_HOLIDAYS>();
            if (table_holidays.Count == 0)
        ...
        public float[] MakeHours(A_TIMEPLAN_LIST dr, bool fornight)
        {
            ...
            for (i = 0; i < 31; i++)
            {
                ...
                if (d1 == 7 || (dr.KIND1 == SomeDataDefsA.Id5DienuNedela && d1 == 6))
                {
                    hr[i] = 0.0f;
                }
                else if (d1 == 6 && dr.KIND1 == SomeDataDefsA.Id6DienuNedela)
                {
        ...
        */
        ...
        public EDayTag[] MakeDayTags(A_TIMEPLAN_LIST dr)
        {
            if (dr == null) return null;
