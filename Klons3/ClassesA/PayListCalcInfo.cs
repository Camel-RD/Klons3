...
namespace KlonsA.Classes
{
    public class PayListCalcInfo
    {
        ...
        public void MakeReportB(A_PAYLISTS_R dr)
        {
            var dr_person = dr.Person;
            var dr_position = dr.Position;
            Name = DataTasksA.GetPersonName(dr.Person);
            PosTitle = dr.Position.TITLE;
            Dates1 = Utils.DateToString(dr.PayList.DT);
            Dates2 = Utils.DateToString(dr.DT1.Value) + " - " + Utils.DateToString(dr.DT2.Value);
            var tab = DataLoaderA.SP_PAY_MATCHLISTS_2X_GetBy_SP_A_PAY_MATCHLISTS_21(dr.ID);
            for (int i = 0; i < tab.Count; i++)
            {
                var dri = tab[i];
                var dts = Utils.DateToString(dri.DT1.Value) + " - " + Utils.DateToString(dri.DT2.Value);
        ...
        public string Calc(A_PAYLISTS_R dr, A_SP_PAY_MATCHLISTS_1X dr_x)
        {
            ...
            if (dr_x.IDSHR1 != null && dr.R1 < 1.0f)
            {
                sr1.SetFromA1(dr_x);
                paid1.SetFromA2(dr_x);
                sr1.HAS_TAXDOC = DataTasksA.IsPersonWithTaxDoc(dr.Person, sr1.DT1, sr1.DT2);
            ...
            if (dr_x.IDSHR2 != null && dr.R2 < 1.0f)
            {
                sr2.SetFromB1(dr_x);
                paid2.SetFromB2(dr_x);
                sr2.HAS_TAXDOC = DataTasksA.IsPersonWithTaxDoc(dr.Person, sr2.DT1, sr2.DT2);
    ...
    public class PayCalcRow
    {
        ...
        public void SetFromA1(A_SP_PAY_MATCHLISTS_1X dr_x)
        {
            ID_P = dr_x.IDP;
            ID_AM = dr_x.IDAM;
            ID_SHR = dr_x.IDSHR1;

            DT1 = dr_x.VA_SHEET_DT1.Value;
            DT2 = dr_x.VA_SHEET_DT2.Value;
            ...
            IINEX2_TP = dr_x.VA1_IINEX2_TP.Value;
            DNSI = dr_x.VA1_DNSI;
        ...
        public void SetFromA2(A_SP_PAY_MATCHLISTS_1X dr_x)
        {
            ID_P = dr_x.IDP;
            ID_AM = dr_x.IDAM;
            ID_SHR = dr_x.IDSHR1;
        ...
        public void SetFromB1(A_SP_PAY_MATCHLISTS_1X dr_x)
        {
            ID_P = dr_x.IDP;
            ID_AM = dr_x.IDAM;
            ID_SHR = dr_x.IDSHR2;

            DT1 = dr_x.VB_SHEET_DT1.Value;
            DT2 = dr_x.VB_SHEET_DT2.Value;
            ...
            IINEX2_TP = dr_x.VB1_IINEX2_TP.Value;
            DNSI = dr_x.VB1_DNSI;
        ...
        public void SetFromB2(A_SP_PAY_MATCHLISTS_1X dr_x)
        {
            ID_P = dr_x.IDP;
            ID_AM = dr_x.IDAM;
            ID_SHR = dr_x.IDSHR2;
        ...
        public void SetFrom(A_SP_PAY_MATCHLISTS_2X dr_x)
        {
            ID_SHR = dr_x.ID_SHR;
            ...
            IINEX2 = dr_x.IINEX2;
            IINEX2_TP = dr_x.IINEX2_TP.Value;
            DNSI = dr_x.DNSI;
        ...
        public void WriteTo1(A_PAYLISTS_R dr)
        {
            if (dr.ID_SHR_1 == ID_SHR &&
        ...
        public void WriteTo2(A_PAYLISTS_R dr)
        {
            if (dr.ID_SHR_2 == ID_SHR &&
