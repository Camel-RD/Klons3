...
namespace KlonsF.Forms
{
    public partial class Form_OpsRules : MyFormBaseF
    {
        ...
        private void FormOpsRules_Load(object sender, EventArgs e)
        {
            ...
            var bl_acp23 = ctx.GetBindingListByType<F_ACP23>();
            var bl_acp25 = ctx.GetBindingListByType<F_ACP25>();
            cbIINien.DataSource = new BindingSource(bl_acp23, null);
            cbIINizd.DataSource = new BindingSource(bl_acp23, null);
            cbPVNien.DataSource = new BindingSource(bl_acp25, null);
            cbPVNizd.DataSource = new BindingSource(bl_acp25, null);
            cbPVNdeb.DataSource = new BindingSource(bl_acp25, null);
            cbPVNkred.DataSource = new BindingSource(bl_acp25, null);
            cbPVN5.DataSource = new BindingSource(bl_acp25, null);
